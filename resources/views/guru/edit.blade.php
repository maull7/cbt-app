            ...
            <div class="p-4 mt-16 min-h-screen">
                <div class="grid grid-cols-1">
                    <div class="card w-auto bg-white-custom shadow-sm">
                        <div class="card-body">
                            <h3 class="lg:text-xl font-medium text-black-custom text-base mb-4">Edit Guru
                            </h3>
                            <form action="{{ route('master_guru.update', $guru->id) }}" method="POST">
                                @csrf
                                @method('PUT')
