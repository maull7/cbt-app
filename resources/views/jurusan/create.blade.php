            ...
            <div class="p-4 mt-16 min-h-screen">
                <div class="grid grid-cols-1">
                    <div class="card w-auto bg-white-custom shadow-sm">
                        <div class="card-body">
                            <h3 class="lg:text-xl font-medium text-black-custom text-base mb-4">Tambah Jurusan
                            </h3>
                            <form action="{{ route('master_jurusan.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    <label for="nama-jurusan"
                                        class="block mb-3 text-sm font-medium text-black-custom">Nama Jurusan</label>
                                    <input type="text"
                                        ...
                                        name="nama_jurusan" id="nama-jurusan" placeholder="Nama jurusan" required>
                                </div>
