                ...
                <div class="grid grid-cols-1">
                    <div class="card w-auto bg-white-custom shadow-sm">
                        <div class="card-body">
                            ...
                            <div class="mb-5">
                                <a href="{{ route('master_ujian.create') }}">
                                    ...
                                    <tbody class="bg-white text-black">
                                        ...
                                        @foreach ($ujian as $data)
                                            <tr>
                                                ...
                                                <td class="px-4 py-2">{{ $data->nama_ujian }}</td>

                                                <td class="px-4 py-2">{{ $data->mapel->nama_mapel }}</td>
                                                <td class="px-4 py-2">{{ $data->jumlah_soal }}</td>
                                                <td class="px-4 py-2">{{ $data->soal_acak == 1 ? 'YA' : 'TIDAK' }}</td>
                                                <td class="px-4 py-2">{{ $data->jawaban_acak == 1 ? 'YA' : 'TIDAK' }}
                                                </td>
                                                ...
                                                <td class="px-4 py-2 flex gap-2">
                                                    ...
                                                    <form action="{{ route('master_ujian.destroy', $data->id) }}"
