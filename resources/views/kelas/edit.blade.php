                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('master_kelas.update', $kelas->id) }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    @if ($errors->has('kelas'))
                                        <div class="text-red-500 text-sm mb-2">{{ $errors->first('kelas') }}</div>
                                    @endif
                                ...
                                <div class="mb-4">
                                    ...
                                    @if ($errors->has('id_jurusan'))
                                        <div class="text-red-500 text-sm mb-2">{{ $errors->first('id_jurusan') }}</div>
                                    @endif
                                ...
                                <div class="mb-4">
                                    ...
                                    @if ($errors->has('nama_kelas'))
                                        <div class="text-red-500 text-sm mb-2">{{ $errors->first('nama_kelas') }}</div>
                                    @endif
                                    <input type="text"
                                        class="border border-gray-custom text-sm rounded-lg block py-3 px-2 text-black-custom w-full md:w-md focus:outline-gray-custom font-medium"
