            ...
            <div class="p-4 mt-16 min-h-screen">
                <div class="grid grid-cols-1">
                    <div class="card w-auto bg-white-custom shadow-sm">
                        <div class="card-body">
                            <h3 class="lg:text-xl font-medium text-black-custom text-base mb-4">Data Master kelas</h3>
                            <div class="mb-5 flex gap-2 flex-wrap">
                                <a href="{{ route('master_kelas.create') }}">
                                    ...
                                    <tbody class="bg-white text-black">
                                        @foreach ($kelas as $data)
                                            <tr class="hover:bg-blue-50 transition-colors duration-200">
                                                ...
                                                <td class="px-4 py-2">
                                                    {{ $data->jurusan->nama_jurusan ?? 'Tidak ada jurusan' }}</td>
                                                <td class="px-4 py-2 flex gap-2">
                                                    <a href="{{ route('master_kelas.edit', base64_encode($data->id)) }}"
                                                        class="btn btn-edit bg-blue-custom text-white-custom"><i
                                                            class="fa-regular fa-pen-to-square"></i></a>
                                                    <form action="{{ route('master_kelas.destroy', $data->id) }}"
