        ...
        <div class="card w-full md:w-md bg-base-100 shadow-sm">
            <div class="card-body">
                ...
                <div class="mt-6">
                    ...
                    <input class="w-full border border-gray-custom text-black-custom text-sm rounded-lg block py-3 px-2 focus:outline-gray-custom" type="text" name="username" id="username" placeholder="Username"></label>
                </div>
                <div class="mt-4">
