            ...
            <div class="p-4 mt-16 min-h-screen">
                <div class="grid grid-cols-1">
                    <div class="card w-auto bg-white-custom shadow-sm">
                        <div class="card-body">
                            <h3 class="lg:text-xl font-medium text-black-custom text-base mb-4">Data Master Siswa</h3>
                                    ...
                                    <tbody class="bg-white text-black">
                                        @foreach ($siswas as $data)
                                            <tr class="hover:bg-blue-50 transition-colors duration-200">
                                                ...
                                                <td class="px-4 py-2">{{ $data->kelas->jurusan->nama_jurusan }}</td>
                                                ...
                                                <td class="px-4 py-2 flex gap-2">
                                                    ...
                                                    <form action="{{ route('master_siswa.destroy', $data->id) }}"
